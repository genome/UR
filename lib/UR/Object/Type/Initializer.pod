...
after UR creates the initial entity so the method will have access to other
parameters used during creation.

Specifying C<default_from E<gt> 1> is equivalent to,

  default_from => '__default_' . $prop_name . '__'
