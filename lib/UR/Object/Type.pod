...
accessor accepts key/value pairs as arguments, and is used to filter the
results of the is_many accessor.  For example, the singular for the 'cars'
accessor is 'car'.

Returns a false value if the given property name is not is_many, or does not
exist.
...
Returns the accessor name used to get the UR::Object::Iterator that corresponds
with the is_many accessor.  For example, the iterator for the 'cars' accessor
is 'car_iterator'.  Returns a false value if the given property name is not
is_many, or does not exist.

=item set_accessor_name_for_is_many_accessor

  $set_name = $class_obj->set_accessor_name_for_is_many_accessor($is_many_name);

Returns the accessor name used to get the UR::Object::Set that corresponds
with the is_many accessor.  For example, the set for the 'cars' accessor
is 'car_set'.  Returns a false value if the given property name is not
is_many, or does not exist.
...
Returns the accessor name used to get the UR::BoolExpr that corresponds
with the is_many accessor.  For example, the rule for the 'cars' accessor
is '__car_rule'.  Returns a false value if the given property name is not
is_many, or does not exist.
...
is 'car_arrayref'.  Returns a false value if the given property name is not
is_many, or does not exist.
...
'add_car'.  Returns a false value if the given property name is not
is_many, or does not exist.
...
the is_many accessor.  For example, the adder for the 'cars' accessor is
'remove_car'.  Returns a false value if the given property name is not
is_many, or does not exist.
