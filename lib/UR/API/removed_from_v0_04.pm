...
UR::API::removed_from_v0_04 - restores changes removed in UR version 0.04 

=head1 SYNOPSIS

use UR::API::removed_from_v0_04;
...
# use modules which have things which were subsequently removed to get fully back to the 0.04 API
use UR::API::removed_from_v0_17;
