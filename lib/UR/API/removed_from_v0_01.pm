...
UR::API::removed_from_v0_01 - restores changes removed in UR version 0.01 

=head1 SYNOPSIS

use UR;
use UR::API::removed_from_v0_01;
...
# the next set of removals are here (which may chain to further removals)
