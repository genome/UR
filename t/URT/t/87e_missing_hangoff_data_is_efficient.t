...
is($query_count, 1, "only did one query to get the muppet, ensuring we succesfully re-wrote the join chain through a generic UR::Object to a specific one with a data source");
