...
our %expected_class_data = (
                Testing => {
                    name  => 'Testing',
                    is    => ['UR::Namespace'],
                    path  => $base_dir.'/test_namespace/Testing.pm',
                    relpath  => 'Testing.pm',
                    file  => 'Testing.pm',
                },
                'Testing::Something' => {
                    ...
                    is    => ['UR::Object'],
                    path  => $base_dir.'/test_namespace/Testing/Something.pm',
                ...
                'Testing::Something::SubClass1' => {
                    ...
                    path  => $base_dir.'/test_namespace/Testing/Something/SubClass1.pm',
                ...
                'Testing::Something::SubClass2' => {
                    ...
                    is    => ['Testing::Something'],
                    path  => $base_dir.'/test_namespace/Testing/Something/SubClass2.pm',
                ...
                'Testing::Color' => {
                    name  => 'Testing::Color',
                    is    => ['UR::Object'],
                    path  => $base_dir.'/test_namespace/Testing/Color.pm',
