...
$load_count = 0;
$query_count = 0;
my @o = URT::Parent->get(the_type_name => 'URT::Child');
is(scalar(@o),   1, 'URT::Parent->get returned 1 object');
is($load_count,  1, 'loaded 1 objects');
ok($o[0]->isa('URT::Child'), 'Loaded object is of the correct type');
is($query_count, 2, 'get() triggered 2 queries');  # 1 on the parent table, 1 more for child joined to parent

$load_count = 0;
$query_count = 0;
@o = URT::Child->get(the_type_name => 'URT::Child', child_value => 'stuff');
