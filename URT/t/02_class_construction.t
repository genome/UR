...
is($URT::Foo::Type::ISA[0], 'UR::Object::Type', "defined class' meta class has correct inheritance");
...
is($URT::Bar::Type::ISA[0], 'UR::Object::Type', "created class' meta class has correct inheritance");
